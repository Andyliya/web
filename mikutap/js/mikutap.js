...
var MainManager = function () {
    ...
    var m, I, z, b = 0, x = 0, C = new function () {
        ...
        var s = function (n, a) {
            ...
            function t() {
                o = 1, gsap.fromTo(c, .9, {rotation: 0}, {
                    rotation: 360,
                    ease: Power1.easeOut,
                    onUpdate: e,
                    onComplete: i
            ...
            this.play = function (n, a) {
                o = 0, d = n, r = a, l = 360 * Math.random(), s = 1, Math.random() < .5 && (s = -1), f.clear(), f.beginFill(0), f.moveTo(0, 0), f.lineTo(1, 1), f.endFill(), gsap.fromTo(c, .6, {rotation: 0}, {
                    rotation: 360,
                    ease: Power1.easeOut,
                    onUpdate: e,
                    onComplete: t
            ...
            this.play = function (n, a) {
                f = n, e = a, function () {
                    ...
                    for (var t = 360 / p, i = 0; i < p; i++) {
                        ...
                        M["p" + i] = {x: r, y: l}, gsap.to(M["p" + i], .6, {x: s, y: d})
                    }
                    M.progress = 0, gsap.to(M, .8, {progress: 1, onUpdate: h, onComplete: c})
                }()
            };
            ...
            var f = function (n) {
                ...
                function o() {
                    0 == u ? (u = 1, s = {x: r.x, y: r.y}, gsap.to(s, f, {
                        x: l.x,
                        y: l.y,
                        ease: Power1.easeOut,
                        onUpdate: i,
                ...
                this.play = function (n, a, e, t) {
                    return v.visible = !0, u = 0, r = n, l = a, d = e, h = t, c = .2 * Math.random() + .2, f = .2 * Math.random() + .2, s = {
                        x: r.x,
                        y: r.y
                    }, gsap.to(s, c, {x: l.x, y: l.y, ease: Power1.easeOut, onUpdate: i, onComplete: o}), c + f
                };
        ...
        var f, u = -1, v = 4, p = 8, y = !1, w = !1, M = [], m = [function (n, a) {
            var s = function (n) {
                ...
                this.play = function (n, a, e) {
                    s.visible = !0, s.clear();
                    var t = G * Math.random(), i = A * Math.random(), o = Math.min(G, A) * (.03 * Math.random() + .02);
                    ...
                    return gsap.to(s, r, {
                        ...
                        ease: Power3.easeOut,
                        onComplete: l
                    }), gsap.to(s.scale, r, {x: 1, y: 1, ease: Back.easeOut.config(1.7)}), r
                };
            ...
            var s = function (n) {
                ...
                this.play = function (n, a, e) {
                    s.visible = !0, s.clear();
                    var t = G * Math.random(), i = A * Math.random(), o = Math.min(G, A) * (.04 * Math.random() + .02);
            ...
            var h = function (n) {
                ...
                function a() {
                    gsap.to(h.scale, .4, {x: 0, y: 0, ease: Power2.easeOut, onComplete: e, delay: .1})
                }
            ...
            this.play = function () {
                !function () {
                    ...
                    var n = L(), a = Math.min(G, A) * (.28 * Math.random() + .2), e = Math.floor(5 * Math.random()) + 3;
                    ...
                    gsap.fromTo(u.scale, .9, {x: s, y: s}, {x: d, y: d, ease: Bounce.easeOut}), v.play(a, h)
                }()
            };
            var e = this, c = n;
            this.id = a;
            ...
            var i = function (n) {
                function e() {
                    ...
                    l.lineStyle(4 * Math.random() + 4, L()), l.drawRect(-a / 2, -a / 2, a, a), l.x = o + n / 2 * (Math.random() - .5), l.y = r + n / 2 * (Math.random() - .5), l.scale.x = 0, l.scale.y = 0, l.rotation = Math.random() * Math.PI, gsap.to(l, .5, {
                        ...
                        onComplete: t
                    }), gsap.to(l.scale, .5, {x: 1, y: 1, ease: Back.easeOut.config(1.7)})
                }

                function t() {
                    var n = Math.min(G, A), a = o + n / 2 * (Math.random() - .5), e = r + n / 2 * (Math.random() - .5);
                    gsap.to(l, .5, {
                        x: a,
                        y: e,
                        rotation: -Math.random() * Math.PI,
                        ...
                        onComplete: i,
                        delay: .2
                    }), gsap.to(l.scale, .5, {x: 0, y: 0, ease: Back.easeIn.config(1.7), delay: .2})
                }
            ...
            var i = function (n) {
                ...
                function a() {
                    gsap.to(l.scale, .5, {x: 0, y: 0, ease: Back.easeIn.config(1.7), onComplete: t, delay: .2})
                }
            ...
            this.play = function () {
                !function () {
                    ...
                    var a = 45 * Math.PI / 180 * Math.floor(2 * Math.random()),
                        ...
                        i = .3 * -Math.random() + 1;
                    gsap.fromTo(d.container, .6, {rotation: a}, {
                        rotation: e,
                        ease: Power2.easeOut
                    }), gsap.fromTo(d.container.scale, .6, {x: t, y: t}, {
                        x: i,
                        y: i,
                        ease: Back.easeOut.config(1.7)
                    }), gsap.fromTo(s.scale, .6, {x: t, y: t}, {x: i, y: i, ease: Back.easeOut.config(1.7)})
                }()
            };
            var e = this, r = n;
            this.id = a;
            ...
            this.play = function () {
                !function () {
                    ...
                    gsap.fromTo(c.scale, s, {x: 0, y: 0}, {
                        x: t,
                        y: t,
                        onComplete: d,
                        ease: Power2.easeOut
                    }), gsap.fromTo(c, s, {rotation: Math.random() * Math.PI}, {
                        rotation: Math.random() * Math.PI,
                        ease: Power1.easeOut
                    })
                }()
            ...
            var u = function (n) {
                function t() {
                    gsap.to(l.scale, .4, {
                        ...
                        onComplete: a,
                        delay: .7
                    }), gsap.to(l, .4, {rotation: Math.random() * Math.PI * 2, ease: Back.easeIn.config(2), delay: .7})
                }
                ...
                this.init = function (n, a, e, t) {
                    ...
                    i = a, l.clear(), l.visibloe = !0, l.beginFill(r), l.drawRect(.5 * -o, .5 * -o, o, o), gsap.fromTo(l.scale, .3, {
                        ...
                        onComplete: t,
                        delay: n
                    }), gsap.fromTo(l, .7, {rotation: Math.random() * Math.PI * 2}, {
                        rotation: 0,
                        ease: Elastic.easeOut.config(1, .3),
                        delay: n
                    });
            ...
            var u = function (n) {
                function e() {
                    ...
                    gsap.to(l.scale, .3, {
                        ...
                        onComplete: t,
                        delay: .5
                    }), gsap.to(l, .3, {x: a, y: e, ease: Power2.easeOut, delay: .5})
                }
            ...
            function o() {
                if (r < ++c) switch (l) {
                    ...
                    case 1:
                        l = 2
                } else gsap.to(f, .1, {x: h[c].x, y: h[c].y, onComplete: o, onUpdate: e, ease: Power1.easeOut})
            }
